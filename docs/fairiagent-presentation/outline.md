...
### 已就绪图片
- `figs/LLMvsAgent.png` — LLM vs Agent 范式对比 → Slide 4
- `figs/poster_fig1_architecture_handdrawn_v5.jpg` — graphical abstract 架构图 → Slide 7
- `figs/memory fig.png` — memory 在小模型上的效果 → Slide 10
- `figs/metadata_generation_f1_presentation.png` — 可选用于 Slide 12
- `figs/value_extraction_accuracy_presentation.png` — 可选用于 Slide 12
- `figs/poster_fig3_fig4_combined.png` — 可选用于 Slide 16

### 需要补的 placeholder
1. Slide 2 — FAIR-DS 界面截图
2. Slide 14 — Ablation bar chart (Full / −Critic / −Rollback / −Memory)
3. Slide 15 — Pass@k 收敛曲线
4. Slide 16 — 三维综合图（如不用已有 combined）
5. Slide 13 — Deep dive trace 数据（LLM 输出片段 + baseline 错误标注）
