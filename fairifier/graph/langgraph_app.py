...
class FAIRifierLangGraphApp:
    ...
    def _should_write_memory(
        ...
        from .nodes import OrchestrateNode
        return OrchestrateNode(self)._should_write_memory(
    ...
    def _is_domain_general(self, insight: str) -> bool:
        from .nodes import OrchestrateNode
        return OrchestrateNode(self)._is_domain_general(insight)
    ...
    def _store_memory_insight(
        ...
        *,
        ...
        from .nodes import OrchestrateNode
        return OrchestrateNode(self)._store_memory_insight(
            state=state,
    ...
    def _retrieve_relevant_memories(
        ...
        from .nodes import OrchestrateNode
        return OrchestrateNode(self)._retrieve_relevant_memories(
            agent_name=agent_name,
            state=state,
            session_id=session_id,
            top_k=top_k,
    ...
    def _memory_scope_ids(
        ...
        from .nodes import OrchestrateNode
        return OrchestrateNode(self)._memory_scope_ids(state, session_id)
