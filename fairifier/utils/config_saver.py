...
def collect_runtime_config(
    ...
    config_dict = {
        ...
        "llm_top_p": getattr(config, "llm_top_p", None),
        "llm_top_k": getattr(config, "llm_top_k", None),
        "llm_repeat_penalty": getattr(config, "llm_repeat_penalty", None),
        "llm_presence_penalty": getattr(config, "llm_presence_penalty", None),
        "llm_max_tokens": config.llm_max_tokens,
        "llm_enable_thinking": config.llm_enable_thinking,
        "llm_thinking_budget": getattr(config, "llm_thinking_budget", 0),
        "llm_reasoning_effort": getattr(config, "llm_reasoning_effort", None),
        "llm_use_responses_api": getattr(config, "llm_use_responses_api", None),
